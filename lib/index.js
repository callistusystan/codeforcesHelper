...
const parseProblem = (directory, URL, inputs, outputs) => {
...
const parseContest = (directory, problems) => {
...
const extract = (directory, URL) => {
  return axios.get(URL)
    .then(({ data }) => {
      ...
      if (inputs.length)
        parseProblem(directory, URL, inputs, outputs);
      else if (problems.length)
        parseContest(directory, problems);
      else {
